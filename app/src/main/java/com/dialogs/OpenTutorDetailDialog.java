...
import com.taxifgo.passenger.CallScreenActivity;
...
public class OpenTutorDetailDialog {
    ...
    public void sinchCall() {
        ...
        if (!generalFunc.isCallPermissionGranted(false)) {
            ...
            OnGoingTripDetailsActivity onGoingTripDetailsActivity = (com.taxifgo.passenger.OnGoingTripDetailsActivity) MyApp.getInstance().getCurrentAct();
