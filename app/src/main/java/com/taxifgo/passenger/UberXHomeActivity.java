...
public class UberXHomeActivity extends BaseActivity {
    ...
    public BubbleToggleView historyArea, walletArea, profileArea, homeArea;
    ...
    me.ibrahimsn.lib.SmoothBottomBar smoothBottomBar ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historyArea = findViewById(R.id.l_item_search);
        walletArea = findViewById(R.id.l_item_wallet);
        profileArea = findViewById(R.id.l_item_profile);
        homeArea = findViewById(R.id.l_item_home);

         homeArea.setTitle(generalFunc.retrieveLangLBl("", "LBL_HOME"));
         walletArea.setTitle(generalFunc.retrieveLangLBl("", "LBL_HEADER_RDU_WALLET"));
         profileArea.setTitle(generalFunc.retrieveLangLBl("", "LBL_HEADER_RDU_PROFILE"));
         historyArea.setTitle(generalFunc.retrieveLangLBl("", "LBL_HEADER_RDU_BOOKINGS"));
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
//            homeArea.setAccessibilityPaneTitle("fffff");
//            profileArea.setBadgeText();
//        }
...
//                .replace(R.id.fragContainer, myBookingFragment).commit();
    ...
    public void manageBottomMenu(MTextView selTextView) {
        ...
        if (selTextView.getId() == homeTxt.getId()) {
            homeTxt.setTextColor(getActContext().getResources().getColor(R.color.appThemeColor_3));
            home_img.setColorFilter(ContextCompat.getColor(getActContext(), R.color.appThemeColor_3), android.graphics.PorterDuff.Mode.SRC_IN);
        } else {
        ...
        if (selTextView.getId() == historyTxt.getId()) {
            historyTxt.setTextColor(getActContext().getResources().getColor(R.color.appThemeColor_3));
            bookingImg.setColorFilter(ContextCompat.getColor(getActContext(), R.color.appThemeColor_3), android.graphics.PorterDuff.Mode.SRC_IN);
        } else {
        ...
        if (selTextView.getId() == walletTxt.getId()) {
            walletTxt.setTextColor(getActContext().getResources().getColor(R.color.appThemeColor_3));
            walletImg.setColorFilter(ContextCompat.getColor(getActContext(), R.color.appThemeColor_3), android.graphics.PorterDuff.Mode.SRC_IN);
        } else {
        ...
        if (selTextView.getId() == profileTxt.getId()) {
            profileTxt.setTextColor(getActContext().getResources().getColor(R.color.appThemeColor_3));
            profileImg.setColorFilter(ContextCompat.getColor(getActContext(), R.color.appThemeColor_3), android.graphics.PorterDuff.Mode.SRC_IN);
        } else {
