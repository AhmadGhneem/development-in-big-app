...
//            FacebookSdk.sdkInitialize(getActContext());
    ...
    private void initview() {
        ...
        titleTxt1 = (MTextView) findViewById(R.id.titleTxt1);
        ...
        imgClose.setOnClickListener(new AppLoignRegisterActivity.setOnClickList());
    ...
    private void setLabel() {
        ...
        if (type != null) {
            if (type.equals("login")) {
                ...
                titleTxt1.setText(generalFunc.retrieveLangLBl("", "LBL_SIGN_IN_TXT"));
                ...
                titleTxt1.setText(generalFunc.retrieveLangLBl("", "LBL_SIGN_UP"));
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (i == backImgView.getId()) {
                ...
                AppLoignRegisterActivity.this.onBackPressed();
            }
        }
    }
