...
public class ProfilePaymentActivity extends AppCompatActivity {
    ...
    MTextView titleTxt, walletLblTxt, walletBalanceTxt, walletBalTxt, cashTxt, cardTxt;
    ImageView addWalletTxt ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addWalletTxt = (ImageView) findViewById(R.id.addWalletTxt);
...
//            cashTxt.setTextColor(getActContext().getResources().getColor(R.color.white));
            cashArea.setBackgroundColor(getActContext().getResources().getColor(R.color.card_green));
//            cardTxt.setTextColor(getActContext().getResources().getColor(R.color.black));
            cardArea.setBackgroundColor(getActContext().getResources().getColor(R.color.card_red));
...
//            cardValArea.setVisibility(View.GONE);
//            cashCardViewarea.setCardBackgroundColor(getActContext().getResources().getColor(R.color.card_green));
//            cardViewarea.setCardBackgroundColor(getActContext().getResources().getColor(R.color.card_red));
        } else {
...
//            cashTxt.setTextColor(getActContext().getResources().getColor(R.color.black));
            cashArea.setBackgroundColor(getActContext().getResources().getColor(R.color.card_red));
            cardArea.setBackgroundColor(getActContext().getResources().getColor(R.color.card_green));
