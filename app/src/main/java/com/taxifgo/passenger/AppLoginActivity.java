...
public class AppLoginActivity extends AppCompatActivity {
    ...
    public void buildLanguageList() {
        ...
        buildCurrencyList();
//        if(Utils.getText(languageText).equalsIgnoreCase("english")){
//            Context context =  LocaleHelper.setLocale(AppLoginActivity.this, "en");
//            android.content.res.Resources resources = context.getResources();
//
//        }else {
            Context context =  LocaleHelper.setLocale(AppLoginActivity.this, "ar");
            android.content.res.Resources resources = context.getResources();
