...
public class CabTypeAdapter extends RecyclerView.Adapter<CabTypeAdapter.ViewHolder> {
    ...
    public void setData(CabTypeAdapter.ViewHolder viewHolder, final int position, boolean isHoverOLD) {
        ...
        if (imgName.equals("")) {
            if (isHover) {
                viewHolder.contentArea.setBackground(mContext.getResources().getDrawable(R.drawable.rect_rounded_corner_car_hover));
                imgUrl = vehicleDefaultIconPath + "hover_ic_car.png";
            } else {
                viewHolder.contentArea.setBackground(mContext.getResources().getDrawable(R.drawable.rect_rounded_corner_car));
